...
import type { Daycation } from '@/data/daycations';

export type { Daycation };

interface DaycationCategory {
  id: string;
  label: string;
  emoji: string;
}
...
interface Props {
  daycations: Daycation[];
  categories: DaycationCategory[];
}
...
export default function DaycationsClient({ daycations, categories }: Props) {
  ...
  const filtered = useMemo(() => {
    ...
    return list;
  }, [activeCategory, sortBy, daycations]);
