...
const OUR_TRIPS = [
  ...
  { slug: 'manali-lahaul-trip-from-delhi', title: 'Manali & Lahaul Trip from Delhi', location: 'Manali + Lahaul Valley, Himachal Pradesh', keywords: ['manali', 'lahaul', 'himachal', 'atal tunnel', 'sissu', 'kullu'], duration: '5D/4N', priceINR: 7699, image: 'https://images.unsplash.com/photo-1741790956655-d4679f77c63d?w=600&q=80', category: 'Adventure Tour', highlights: ['Lahaul Valley beyond tourist trail', 'Atal Tunnel at 10,000 ft', 'Sissu waterfall & Tandi confluence'], href: '/destinations/domestic/manali-lahaul-trip-from-delhi' },
  { slug: 'manali-honeymoon-package', title: 'Manali Honeymoon Package', location: 'Manali, Himachal Pradesh', keywords: ['manali', 'honeymoon', 'himachal', 'solang', 'hadimba', 'couple', 'romantic'], duration: '5D/4N', priceINR: 9349, image: 'https://images.unsplash.com/photo-1548690375-1bdf6c661222?w=600&q=80', category: 'Honeymoon', highlights: ['Candlelight dinner with mountain views', 'Couple spa at Vashisht hot springs', 'Private sightseeing — Solang, Hadimba'], href: '/destinations/domestic/manali-honeymoon-package' },
  { slug: 'kullu-manali-tour-package', title: 'Kullu Manali Tour Package', location: 'Kullu + Manali, Himachal Pradesh', keywords: ['kullu', 'manali', 'himachal', 'rohtang', 'solang', 'naggar', 'river rafting'], duration: '6D/5N', priceINR: 6599, image: 'https://images.unsplash.com/photo-1603612692333-7bac35e43500?w=600&q=80', category: 'Holiday Package', highlights: ['River rafting on the Beas', 'Rohtang Pass views', 'Naggar Castle'], href: '/destinations/domestic/kullu-manali-tour-package' },
  { slug: 'manali-leh-bike-trip', title: 'Manali to Leh Ladakh Bike Trip', location: 'Manali → Leh, Himachal Pradesh & Ladakh', keywords: ['manali', 'leh', 'ladakh', 'bike trip', 'rohtang', 'khardung la', 'pangong', 'nubra'], duration: '9D/8N', priceINR: 26949, image: 'https://images.unsplash.com/photo-1574701427742-acc058398496?w=600&q=80', category: 'Bike Trip', highlights: ['Rohtang Pass to Khardung La', 'Pangong Tso Lake at sunrise', 'Nubra Valley camel safari'], href: '/destinations/domestic/manali-leh-bike-trip' },
  { slug: 'spiti-valley-tour-from-manali', title: 'Spiti Valley Tour from Manali', location: 'Spiti Valley, Himachal Pradesh', keywords: ['spiti', 'manali', 'kaza', 'key monastery', 'chandratal', 'rohtang', 'himachal'], duration: '5D/4N', priceINR: 17599, image: 'https://images.unsplash.com/photo-1652131812743-07bc5dde8b91?w=600&q=80', category: 'Adventure Tour', highlights: ['Rohtang Pass 13,054 ft', 'Key Monastery at 13,668 ft', 'Chandratal Lake 14,100 ft'], href: '/destinations/domestic/spiti-valley-tour-from-manali' },
