// Shared domestic trip data

export interface DomesticTrip {
  slug: string;
  title: string;
  location: string;
...
export const DOMESTIC_TRIPS: DomesticTrip[] = [
  {
